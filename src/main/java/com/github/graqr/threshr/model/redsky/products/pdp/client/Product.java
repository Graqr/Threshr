...
@Serdeable
public record Product(@JsonProperty("__typename") String typename, String tcin, Category category,
                      ...
                      @JsonProperty("finds_posts") List<FindsPost> findsPosts, Price price, List<?> promotions) {
}
